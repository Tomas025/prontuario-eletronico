      ...
      const matchesSearchQuery = searchQuery
        ? columns.some((column) => {
          const cellValue = column.render
            ? String(column.render(row)).replace(/<[^>]+>/g, '').trim()
        ...
        <div className="flex justify-between items-center px-4 py-3 bg-white border-t">
          ...
          <div className="flex items-center">
            <button
              ...
              className={`w-8 h-8 flex justify-center items-center rounded-full mx-1 ${currentPage === 1 ? 'text-blue/04' : 'hover:bg-blue/07'
                }`}
            >
              <FaAngleLeft />
            </button>
            {visiblePages.map((page) => (
              <button
                ...
                className={`w-8 h-8 flex justify-center items-center rounded-full mx-1 ${currentPage === page
            ...
            <button
              ...
              className={`w-8 h-8 flex justify-center items-center rounded-full mx-1 ${currentPage === totalPages ? 'text-blue/04' : 'hover:bg-blue/07'
                }`}
            >
              <FaAngleRight />
            </button>
